...
//        Question 1
        ...
        int q1Score = 0;
        RadioButton q1answer1 = (RadioButton) findViewById(R.id.q1a1);
        boolean q1a1IsChecked = q1answer1.isChecked();
        RadioButton q1answer2 = (RadioButton) findViewById(R.id.q1a2);
        boolean q1a2IsChecked = q1answer2.isChecked();
        RadioButton q1answer3 = (RadioButton) findViewById(R.id.q1a3);
        boolean q1a3IsChecked = q1answer3.isChecked();
        RadioButton q1answer4 = (RadioButton) findViewById(R.id.q1a4);
        ...
        int q2Score = 0;
        CheckBox q2answer1 = (CheckBox) findViewById(R.id.q2a1);
        boolean q2a1IsChecked = q2answer1.isChecked();
        CheckBox q2answer2 = (CheckBox) findViewById(R.id.q2a2);
        boolean q2a2IsChecked = q2answer2.isChecked();
        CheckBox q2answer3 = (CheckBox) findViewById(R.id.q2a3);
        boolean q2a3IsChecked = q2answer3.isChecked();
        CheckBox q2answer4 = (CheckBox) findViewById(R.id.q2a4);
...
//        Question 3
        ...
        EditText question3 = (EditText) findViewById(R.id.question_three_input);
        ...
        int q4Score = 0;
        RadioButton q4answer1 = (RadioButton) findViewById(R.id.q4a1);
        boolean q4a1IsChecked = q4answer1.isChecked();
        RadioButton q4answer2 = (RadioButton) findViewById(R.id.q4a2);
        boolean q4a2IsChecked = q4answer2.isChecked();
        RadioButton q4answer3 = (RadioButton) findViewById(R.id.q4a3);
        boolean q4a3IsChecked = q4answer3.isChecked();
        RadioButton q4answer4 = (RadioButton) findViewById(R.id.q4a4);
        ...
        int q5Score = 0;
        RadioButton q5answer1 = (RadioButton) findViewById(R.id.q5a1);
        boolean q5a1IsChecked = q5answer1.isChecked();
        RadioButton q5answer2 = (RadioButton) findViewById(R.id.q5a2);
        boolean q5a2IsChecked = q5answer2.isChecked();
        RadioButton q5answer3 = (RadioButton) findViewById(R.id.q5a3);
        boolean q5a3IsChecked = q5answer3.isChecked();
        RadioButton q5answer4 = (RadioButton) findViewById(R.id.q5a4);
...
//        Question 6
        ...
        EditText question6 = (EditText) findViewById(R.id.question_six_input);
        ...
        int q7Score = 0;
        RadioButton q7answer1 = (RadioButton) findViewById(R.id.q7a1);
        boolean q7a1IsChecked = q7answer1.isChecked();
        RadioButton q7answer2 = (RadioButton) findViewById(R.id.q7a2);
        boolean q7a2IsChecked = q7answer2.isChecked();
        RadioButton q7answer3 = (RadioButton) findViewById(R.id.q7a3);
        boolean q7a3IsChecked = q7answer3.isChecked();
        RadioButton q7answer4 = (RadioButton) findViewById(R.id.q7a4);
        ...
        int q8Score = 0;
        RadioButton q8answer1 = (RadioButton) findViewById(R.id.q8a1);
        boolean q8a1IsChecked = q8answer1.isChecked();
        RadioButton q8answer2 = (RadioButton) findViewById(R.id.q8a2);
        boolean q8a2IsChecked = q8answer2.isChecked();
        RadioButton q8answer3 = (RadioButton) findViewById(R.id.q8a3);
        ...
        int q9Score = 0;
        RadioButton q9answer1 = (RadioButton) findViewById(R.id.q9a1);
        boolean q9a1IsChecked = q9answer1.isChecked();
        RadioButton q9answer2 = (RadioButton) findViewById(R.id.q9a2);
        boolean q9a2IsChecked = q9answer2.isChecked();
        RadioButton q9answer3 = (RadioButton) findViewById(R.id.q9a3);
